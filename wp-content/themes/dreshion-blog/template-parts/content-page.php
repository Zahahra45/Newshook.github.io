...
<article id="post-<?php the_ID(); ?>" <?php post_class( 'hentry' ); ?>>
	<?php 
	$page_img_enable = get_theme_mod( 'dreshion_blog_enable_single_page_image', true );
	...
	<?php 
	$page_author_enable = get_theme_mod( 'dreshion_blog_enable_single_page_author', false );
