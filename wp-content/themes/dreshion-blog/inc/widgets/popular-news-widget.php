...
function dreshion_blog_popular_news() {
	register_widget( 'Dreshion_Blog_Popular_Posts' );
}
add_action( 'widgets_init', 'dreshion_blog_popular_news' );

class Dreshion_Blog_Popular_Posts extends WP_Widget{ 
	...
	function __construct() {
		...
		parent::__construct( 'Dreshion_Blog_Popular_Posts',esc_html__( 'ST: Popular Posts', 'dreshion-blog' ), $widget_popular, $control_ops );
	}
	...
	?>
	    ...
	    <p>
	    	<label for="<?php echo esc_attr($this->get_field_id( 'number' )); ?>">
	    		<?php echo esc_html__( 'Choose Number (Max: 5)', 'dreshion-blog' );?>    		
	    	</label>
