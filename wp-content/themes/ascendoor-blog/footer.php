...
if ( ! is_front_page() || is_home() ) { ?>
			...
			<div class="ascendoor-wrapper">
				<div class="site-footer-bottom-wrapper">
					<div class="site-info">
						<?php
						/**
						 * Hook: ascendoor_blog_footer_copyright.
						 *
						 * @hooked - ascendoor_blog_output_footer_copyright_content - 10
						 */
						do_action( 'ascendoor_blog_footer_copyright' );
						?>
					</div><!-- .site-info -->
				</div>
			</div>
	...
	<?php
	$is_scroll_top_active = get_theme_mod( 'ascendoor_blog_scroll_top', true );
