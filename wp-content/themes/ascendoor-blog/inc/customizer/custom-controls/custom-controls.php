...
if ( class_exists( 'WP_Customize_Control' ) ) {
	 ...
	 */
	class Ascendoor_Blog_Toggle_Switch_Custom_Control extends WP_Customize_Control {
		/**
	 ...
	 */
	class Ascendoor_Blog_Customize_Horizontal_Line extends WP_Customize_Control {
		/**
		 * Control Type
		 */
		public $type = 'hr';
