        ...
        function wpaicgSaveTemplate(e){
            ...
            if(!has_error && (best_of > 20 || best_of < 0)){
                has_error = '<?php echo sprintf(
                    ...
                    esc_html__('Please enter a valid best of value between %1$d and %2$d.','gpt3-ai-content-generator'),0,20)?>';
            }
            if(!has_error && (top_p > 1 || top_p < 0)){
                has_error = '<?php echo sprintf(
                    /* translators: 1: minimum top p value, 2: maximum top p value */
                    esc_html__('Please enter a valid top p value between %1$d and %2$d.','gpt3-ai-content-generator'),0,1)?>';
            }
            if(!has_error && (frequency_penalty > 2 || frequency_penalty < 0)){
                has_error = '<?php echo sprintf(
                    ...
                    esc_html__('Please enter a valid frequency penalty value between %1$d and %2$d.','gpt3-ai-content-generator'),0,2)?>';
            }
            if(!has_error && (presence_penalty > 2 || presence_penalty < 0)){
                has_error = '<?php echo sprintf(
                    ...
                    esc_html__('Please enter a valid presence penalty value between %1$d and %2$d.','gpt3-ai-content-generator'),0,2)?>';
            }
            if(!has_error && (model === 'gpt-3.5-turbo' || model === 'text-davinci-003' || model === 'gpt-3.5-turbo-instruct') && (max_tokens > 4096 || max_tokens < 0)){
                has_error = '<?php echo sprintf(
                    ...
                    esc_html__('For gpt-3.5-turbo, gpt-3.5-turbo-instruct or text-davinci-003, please enter a valid max token value between %1$d and %2$d.','gpt3-ai-content-generator'),0,4096)?>';
            }
            if(!has_error && model === 'gpt-4' && (max_tokens > 8192 || max_tokens < 0)){
                has_error = '<?php echo sprintf(
                    /* translators: 1: minimum max token value, 2: maximum max token value */
                    esc_html__('For gpt-4, please enter a valid max token value between %1$d and %2$d.','gpt3-ai-content-generator'),0,8192)?>';
            }
            if(!has_error && model === 'gpt-3.5-turbo-16k' && (max_tokens > 16384 || max_tokens < 0)){
                has_error = '<?php echo sprintf(
                    /* translators: 1: minimum max token value, 2: maximum max token value */
                    esc_html__('For gpt-3.5-turbo-16k, please enter a valid max token value between %1$d and %2$d.','gpt3-ai-content-generator'),0,16384)?>';
            }
            if(!has_error && model === 'gpt-4-32k' && (max_tokens > 32768 || max_tokens < 0)){
                has_error = '<?php echo sprintf(
                    /* translators: 1: minimum max token value, 2: maximum max token value */
                    esc_html__('For gpt-4-32k, please enter a valid max token value between %1$d and %2$d.','gpt3-ai-content-generator'),0,32768)?>'
            }
            if (!has_error && model === 'gpt-4-1106-preview' && (max_tokens > 128000 || max_tokens < 0)) {
                has_error = '<?php echo sprintf(
                    /* translators: 1: minimum max token value, 2: maximum max token value */
                    esc_html__('For gpt-4-1106-preview, please enter a valid max token value between %1$d and %2$d.','gpt3-ai-content-generator'), 0, 128000) ?>';
            }
            if (!has_error && model === 'gpt-4-vision-preview' && (max_tokens > 128000 || max_tokens < 0)) {
                has_error = '<?php echo sprintf(
                    /* translators: 1: minimum max token value, 2: maximum max token value */
                    esc_html__('For gpt-4-vision-preview, please enter a valid max token value between %1$d and %2$d.','gpt3-ai-content-generator'), 0, 128000) ?>';
            }
            if(!has_error && (model === 'text-ada-001' || model === 'text-babbage-001' || model === 'text-curie-001') && (max_tokens > 2049 || max_tokens < 0)){
                has_error = '<?php echo sprintf(
                    /* translators: 1: minimum max token value, 2: maximum max token value */
                    esc_html__('For ada, babbage and curie, please enter a valid max token value between %1$d and %2$d.','gpt3-ai-content-generator'),0,2049)?>'
            }
            if(has_error){
                alert(has_error);
            }
