        ...
        <?php if ($wpaicg_provider == 'OpenAI'): ?>
            ...
            <select name="template[model]" class="regular-text wpaicg_custom_template_model">
                ...
                <optgroup label="GPT-3">
                    <?php display_options($gpt3_models, $wpaicg_parameters['model']); ?>
                </optgroup>
                <optgroup label="Legacy Models">
                    <?php display_options($legacy_models, $wpaicg_parameters['model']); ?>
                </optgroup>
...
<script>
    ...
    modelSelect.addEventListener('change', function () {
        if (this.value === 'gpt-4' || this.value === 'gpt-4-32k' || this.value === 'gpt-4-1106-preview' || this.value === 'gpt-4-vision-preview') {
