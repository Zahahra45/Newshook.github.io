...
<p>
    <?php 
    printf(
        /* translators: 1: Shortcode, 2: Start link tag, 3: Close link tag */
        esc_html__('Include the shortcode %1$s in the desired location on your site. Learn how you can train the chat bot with your content %2$shere%3$s.', 'gpt3-ai-content-generator'), 
        '<code>[wpaicg_chatgpt]</code>', 
        '<a href="https://docs.aipower.org/docs/ChatGPT/chatgpt-wordpress" target="_blank">',
        '</a>'
    ); 
    ?>
</p>
        ...
        <form action="" method="post" id="form-chatbox-setting">
                ...
                <div class="wpaicg-collapse-content">
                    <div class="mb-5">
                        ...
                        if ($wpaicg_provider === 'OpenAI') {
                            ...
                            <select class="regular-text" id="wpaicg_chat_model" name="wpaicg_chat_shortcode_options[model]">
                                ...
                                <optgroup label="GPT-3">
                                    <?php display_options($gpt3_models, $wpaicg_settings); ?>
                                </optgroup>
                                <optgroup label="Legacy Models">
                                    <?php display_options($legacy_models, $wpaicg_settings); ?>
                                </optgroup>
                        ...
                        <?php
                            ...
                            ?>
                            <label class="wpaicg-form-label"><?php echo esc_html__('Deployment', 'gpt3-ai-content-generator'); ?>:</label>
                            <input type="text" class="regular-text" name="wpaicg_azure_deployment_input" placeholder="<?php echo esc_html__('Enter Azure Deployment', 'gpt3-ai-content-generator'); ?>" value="<?php echo esc_attr($deployment_name); ?>">
                        <?php
                        }
                        ?>
                    </div>
            ...
            <div class="wpaicg-collapse">
                ...
                <div class="wpaicg-collapse-content">
                    ...
                    if($wpaicg_provider === 'Azure'):
                        echo '<div class="wpaicg-notice-info">'. esc_html__('Moderation is not available in Azure. If you want to use the moderation tool, please change your provider to OpenAI under Settings - AI Engine tab.', 'gpt3-ai-content-generator') .'</div>';
                    endif;
                    ?>

                    <div class="mb-5">
                        <label class="wpaicg-form-label"><?php echo esc_html__('Enable','gpt3-ai-content-generator')?>:</label>
                        <input<?php echo isset($wpaicg_settings['moderation']) && $wpaicg_settings['moderation'] ? ' checked': ''?>  name="wpaicg_chat_shortcode_options[moderation]" value="1" type="checkbox" <?php if(!\WPAICG\wpaicg_util_core()->wpaicg_is_pro() || $wpaicg_provider === 'Azure') echo 'disabled'; ?>>
                    </div>
                    <div class="mb-5">
                        <label class="wpaicg-form-label"><?php echo esc_html__('Model','gpt3-ai-content-generator')?>:</label>
                        <select class="regular-text"  name="wpaicg_chat_shortcode_options[moderation_model]" <?php if(!\WPAICG\wpaicg_util_core()->wpaicg_is_pro() || $wpaicg_provider === 'Azure') echo 'disabled'; ?>>
                    ...
                    <div class="mb-5">
                        ...
                        <textarea rows="8" name="wpaicg_chat_shortcode_options[moderation_notice]" <?php if(!\WPAICG\wpaicg_util_core()->wpaicg_is_pro() || $wpaicg_provider === 'Azure') echo 'disabled'; ?>><?php echo isset($wpaicg_settings['moderation_notice']) ? esc_html($wpaicg_settings['moderation_notice']) : ''?></textarea>
                    </div>
                </div>
            </div>
            <!--End Moderation-->
            ...
            <div class="wpaicg-collapse">
                ...
                <div class="wpaicg-collapse-content">
                    ...
                    if ($wpaicg_provider !== 'Azure') {  // If the provider isn't Azure, display the fields
                    ?>
                    ...
                    ?>
                        <div class="wpaicg-notice-info">
                            <?php echo esc_html__('Speech to Text is not available in Azure. If you want to use it, change your provider to OpenAI under Settings - AI Engine.', 'gpt3-ai-content-generator'); ?>
                        </div>
                    <?php 
                    }
                    ?>
                    ...
                    <div class="mb-5">
                        ...
                        <input <?php echo $wpaicg_chat_to_speech ? 'checked' : ''; ?> value="1" type="checkbox" name="wpaicg_chat_shortcode_options[chat_to_speech]" class="wpaicg_chat_to_speech">
                    </div>
                    <?php
                    $wpaicg_provider = get_option('wpaicg_provider', 'OpenAI'); // Fetching the provider
                    ...
                    $openai_disabled = $wpaicg_provider === 'Azure' ? 'disabled' : '';
                    ?>
                    <div class="mb-5">
                        <label class="wpaicg-form-label"><?php echo esc_html__('Provider','gpt3-ai-content-generator')?>:</label>
                        <select name="wpaicg_chat_shortcode_options[voice_service]" class="wpaicg_voice_service" <?php echo $disabled_voice_fields ? 'disabled' : ''; ?>>
                    ...
                    <?php
                    // Retrieve OpenAI settings with default values
                    ...
                    <div class="wpaicg_voice_service_openai" style="<?php echo $wpaicg_chat_voice_service == 'openai' ? '' : 'display:none'?>">
                        ...
                        <div class="mb-5">
                            <label class="wpaicg-form-label"><?php echo esc_html__('Model','gpt3-ai-content-generator')?>:</label>
                            <select name="wpaicg_chat_shortcode_options[openai_model]" class="wpaicg_openai_model" <?php echo $disabled_voice_fields ? 'disabled' : ''; ?>>
                        ...
                        <div class="mb-5">
                            <label class="wpaicg-form-label"><?php echo esc_html__('Voice','gpt3-ai-content-generator')?>:</label>
                            <select name="wpaicg_chat_shortcode_options[openai_voice]" class="wpaicg_openai_voice" <?php echo $disabled_voice_fields ? 'disabled' : ''; ?>>
                        ...
                        <div class="mb-5">
                            <label class="wpaicg-form-label"><?php echo esc_html__('Output Format', 'gpt3-ai-content-generator'); ?>:</label>
                            <select name="wpaicg_chat_shortcode_options[openai_output_format]" class="wpaicg_openai_output_format" <?php echo $disabled_voice_fields ? 'disabled' : ''; ?>>
                        ...
                        <!-- OpenAI Voice Speed Selection -->
                        <div class="mb-5">
                            <label class="wpaicg-form-label"><?php echo esc_html__('Voice Speed (0.25 to 4.0)', 'gpt3-ai-content-generator'); ?>:</label>
                            <input type="number" name="wpaicg_chat_shortcode_options[openai_voice_speed]" class="wpaicg_openai_voice_speed" min="0.25" max="4.0" step="0.01" value="<?php echo esc_attr($wpaicg_openai_voice_speed); ?>" <?php echo $disabled_voice_fields ? 'disabled' : ''; ?>>
                        </div>
                    </div>
                    ...
                    <div class="wpaicg_voice_service_elevenlabs" style="<?php echo $wpaicg_chat_voice_service == 'google' || (empty($wpaicg_google_api_key) && empty($wpaicg_elevenlabs_api)) ? 'display:none' : ''?>">
                        ...
                        <div class="mb-5">
                            <label class="wpaicg-form-label"><?php echo esc_html__('Select a Model','gpt3-ai-content-generator')?>:</label>
                            <select<?php echo empty($wpaicg_elevenlabs_api) || $disabled_voice_fields ? ' disabled':''?> name="wpaicg_chat_shortcode_options[elevenlabs_model]" class="wpaicg_elevenlabs_model">
                                <?php
                            ...
                            <p class="wpaicg-notice" style="display: none;">
                                <?php echo esc_html__('Multilingual v1 Limitations: Some numbers and symbols may currently be pronounced incorrectly. The generated speech can be unstable if the text exceeds 1000 characters.', 'gpt3-ai-content-generator'); ?>
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="wpaicg-collapse-content">
                    ...
                    <div class="mb-5">
                        <label class="wpaicg-form-label">
                            ...
                            <small style="font-weight: normal;display: block">
                            <?php 
                            printf(
                                /* translators: 1: [sitename] shortcode, 2: [siteurl] shortcode, 3: [domain] shortcode, 4: [date] shortcode */
                                esc_html__('You can include the following shortcode in the context: %1$s, %2$s, %3$s, and %4$s.', 'gpt3-ai-content-generator'), 
                                '<code>[sitename]</code>', 
                                '<code>[siteurl]</code>', 
                                '<code>[domain]</code>', 
                                '<code>[date]</code>'
                    ...
                    <div class="mb-5">
                        ...
                        <?php 
                            $wpaicg_provider = get_option('wpaicg_provider', 'OpenAI'); 
                            if ($wpaicg_provider === 'Azure' && $wpaicg_settings['embedding']) {
                                echo '<div class="wpaicg-notice-info">';
                                echo esc_html__('Make sure that you entered your Azure embeddings name under Settings - AI Engine.', 'gpt3-ai-content-generator');
                                echo '</div>';
                            }
                            ?>
                    </div>
                        ...
                        <div class="mb-5">
                            <label class="wpaicg-form-label">
                                ...
                                <small style="font-weight: normal;display: block">
                                    <?php 
                                    printf(
                                        /* translators: 1: [questions] shortcode */
                                        esc_html__('You can include the following shortcode in the message: %1$s.','gpt3-ai-content-generator'), 
                                        '<code>[questions]</code>'
                                    ); 
                                    ?>
                                </small>
...
<script>
    jQuery(document).ready(function ($){
        ...
        function wpaicgtoggleNotice() {
                // Check if Text to Speech is enabled
                var isTextToSpeechEnabled = $('.wpaicg_chat_to_speech').prop('checked');

                if (isTextToSpeechEnabled && $('.wpaicg_elevenlabs_model').val() === 'eleven_multilingual_v1') {
                    $('.wpaicg-notice').show();
                } else {
                    $('.wpaicg-notice').hide();
                }
        ...
        $('.wpaicg_elevenlabs_model').on('change', wpaicgtoggleNotice);
        
        // Listen for changes on the Text to Speech checkbox
        $('.wpaicg_chat_to_speech').on('change', wpaicgtoggleNotice);
