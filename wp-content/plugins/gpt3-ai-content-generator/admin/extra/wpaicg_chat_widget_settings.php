    ...
    <div class="wpaicg-grid-1">
        <form action="" method="post" id="form-chatbox-setting">
            ...
            <div class="wpaicg-collapse">
                ...
                <div class="mb-5">
                    ...
                    <?php if ($wpaicg_provider === 'Azure'): ?>
                        ...
                        <input type="text" class="regular-text" id="wpaicg_azure_model" name="wpaicg_azure_model" value="<?php echo esc_attr($azure_model); ?>" placeholder="<?php echo esc_attr__('Enter Azure Deployment Name', 'gpt3-ai-content-generator'); ?>">
                    <?php else: ?>
                        <?php
                        $gpt4_models = [
                            'gpt-4' => 'GPT-4',
                    ...
                    <select class="regular-text" id="wpaicg_chat_model" name="wpaicg_chat_model">
                        ...
                        <optgroup label="GPT-3">
                            <?php display_options($gpt3_models, $wpaicg_chat_model); ?>
                        </optgroup>
                        <optgroup label="Legacy Models">
                            <?php display_options($legacy_models, $wpaicg_chat_model); ?>
                        </optgroup>
            ...
            <div class="wpaicg-collapse">
                ...
                <div class="wpaicg-collapse-content">
                    <?php
                    if(!\WPAICG\wpaicg_util_core()->wpaicg_is_pro() || $wpaicg_provider === 'Azure'):
                        if($wpaicg_provider === 'Azure'):
                            echo '<div class="wpaicg-notice-info">'. esc_html__('Moderation is not available in Azure. If you want to use the moderation tool, please change your model to OpenAI under Settings - AI Engine tab.', 'gpt3-ai-content-generator') .'</div>';
                        endif;
                    ?>
                        <!-- The non-pro version content (disabled fields) -->
                        <div class="mb-5">
                    ...
                    ?>
                        <!-- The pro version content (enabled fields) -->
                        <div class="mb-5">
                            <label class="wpaicg-form-label"><?php echo esc_html__('Enable','gpt3-ai-content-generator')?>:</label>
            ...
            <div class="wpaicg-collapse">
                ...
                <div class="wpaicg-collapse-content">
                    ...
                    if ($wpaicg_provider !== 'Azure') {
                        // Extracting the settings for easier usage
            ...
            <div class="wpaicg-collapse">
                ...
                <div class="wpaicg-collapse-content">
                    ...
                    <div class="mb-5">
                        <label class="wpaicg-form-label" style="vertical-align:top">
                            ...
                            <?php echo sprintf(
                                ...
                                esc_html__('You can add shortcode %1$s, %2$s, %3$s and %4$s in context','gpt3-ai-content-generator'),'<code>[sitename]</code>','<code>[siteurl]</code>','<code>[domain]</code>','<code>[date]</code>')?>
                            </small>
                        </label>
                    ...
                    <div class="mb-5">
                        ...
                        <?php 
                            $wpaicg_provider = get_option('wpaicg_provider', 'OpenAI'); 
                            if ($wpaicg_provider === 'Azure' && $wpaicg_chat_embedding) {
                        ...
                        <div class="mb-5">
                            <label class="wpaicg-form-label" style="vertical-align:top">
                                ...
                                <?php echo sprintf(
                                    ...
                                    esc_html__('You can include the following shortcode in the message: %s.','gpt3-ai-content-generator'),'<code>[questions]</code>')?>
                                </small>
                            </label>
