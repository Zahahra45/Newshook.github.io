...
// Get and sanitize the 'id' parameter for nonce verification
$wpaicg_delete_id = isset($_GET['id']) ? sanitize_text_field($_GET['id']) : '';

// Verify nonce for the delete action
...
if (isset($_GET['sub_action']) && sanitize_text_field($_GET['sub_action']) == 'delete' && !empty($wpaicg_delete_id)) {
