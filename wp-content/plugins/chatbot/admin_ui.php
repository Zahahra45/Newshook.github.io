    ...
    <header class="<?php esc_attr_e( 'wp-chatbot-admin-header',  'wpbot' );  ?> ">
      <div class="<?php esc_attr_e( 'row',  'wpbot' );  ?> ">
        <div class="<?php esc_attr_e( 'col-sm-6',  'wpbot' );  ?> ">
          <h2><?php esc_html_e('WPBot Control Panel', 'wpbot'); ?><?php echo get_option('wp_chatbot_index_meta'); ?></h2>
        </div>
      ...
      <div class="<?php esc_attr_e( 'wp-chatbot-tabs wp-chatbot-tabs-style-flip',  'wpbot' );  ?> ">
        <nav>
          <ul>
            ...
            <li tab-data="rpl',  'wpbot' );  ?> "><a href="<?php echo esc_url($action .'&tab=rpl',  'wpbot' );  ?> "> <span class="<?php esc_attr_e( 'wpwbot-admin-tab-icon',  'wpbot' );  ?> "> <i class="<?php esc_attr_e( 'fa fa-plug',  'wpbot' );  ?> "></i> </span> <span class="<?php esc_attr_e( 'wpwbot-admin-tab-name',  'wpbot' );  ?> "> <?php esc_html_e('Conversational Form', 'wpbot'); ?> </span> </a>
            </li>
          </ul>
                ...
                <div class="<?php esc_attr_e( 'col-xs-12',  'wpbot' );  ?> ">
                  ...
                  <div class="<?php esc_attr_e( 'cxsc-settings-blocks',  'wpbot' );  ?> ">
                    <div class="<?php esc_attr_e( 'form-group',  'wpbot' );  ?> ">
                      ...
                      <label for="qlcd_wp_chatbot_from_email',  'wpbot' );  ?>"><?php esc_html_e('All emails will be sent from this email address. If you change the From Email Address then please make sure the domain remains same. Otherwise, the emails may not be received.', 'wpbot'); ?> </label>
                    </div>
                  </div>
                </div>
              </div>
                  ...
                  <div class="<?php esc_attr_e( 'row',  'wpbot' );  ?> ">
                    <div class="<?php esc_attr_e( 'col-xs-12',  'wpbot' );  ?> ">
                      ...
                      <div class="<?php esc_attr_e( 'cxsc-settings-blocks',  'wpbot' );  ?> ">
                        <div class="<?php esc_attr_e( 'form-group',  'wpbot' );  ?> ">
                          <h4 class="<?php esc_attr_e( 'qc-opt-title',  'wpbot' );  ?> ">
                            <?php _e('WPBot Icon Background Color.', 'wpbot'); ?>
                          </h4>
                ...
                <div class="<?php esc_attr_e( 'row',  'wpbot' );  ?> "> <span class="<?php esc_attr_e( 'pull-right',  'wpbot' );  ?> "> </span>
                  <div class="<?php esc_attr_e( 'col-xs-12',  'wpbot' );  ?> ">
                    ...
                    <div class="<?php esc_attr_e( 'cxsc-settings-blocks',  'wpbot' );  ?> ">
                      ...
                      <?php
                       $answer = !is_array($ans) ?  stripcslashes($ans) : $ans;
              ...
              <div class="<?php esc_attr_e( 'row',  'wpbot' );  ?> ">
                <div class="<?php esc_attr_e( 'col-xs-12',  'wpbot' );  ?> ">
                  ...
                  <div class="<?php esc_attr_e( 'cxsc-settings-blocks',  'wpbot' );  ?> ">
                    ...
                    <label for="<?php esc_attr_e( 'enable_wp_chatbot_dailogflow',  'wpbot' );  ?>"><?php esc_html_e('Enable DialogFlow AI Engine to process Natural Language commands from users.', 'wpbot'); ?> </label>
                  </div>
                </div>
                ...
                <div class="<?php esc_attr_e( 'col-xs-12',  'wpbot' );  ?>" id="<?php esc_attr_e( 'wp-chatbot-dialflow-section',  'wpbot' );  ?>">
                  ...
                  <div id="<?php esc_attr_e( 'wp-chatbot-df-section-v2',  'wpbot' );  ?>" style="display:block"> 
                    ...
                    <div class="<?php esc_attr_e( 'form-group',  'wpbot' );  ?> ">
                      ...
                      <p><?php esc_html_e('Put your google service account`s private key JSON string here. You can follow the', 'wpbot'); ?> <a href="<?php echo esc_url('https://www.youtube.com/watch?v=qY-EHFY2wH8', 'wpbot'); ?>" target="_blank"><?php esc_html_e('tutorial', 'wpbot'); ?></a> <?php esc_html_e('to get private key JSON file. ', 'wpbot'); ?></p>
